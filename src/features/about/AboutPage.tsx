    ...
    return (
        <div className="py-20 bg-background">
            <Container>
                ...
                >
                    <h1 className="text-4xl font-bold tracking-tight mb-4 text-slate-900 dark:text-slate-50">Sobre Nosotros</h1>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="bg-slate-100 dark:bg-slate-800 rounded-2xl h-64 md:h-96 w-full flex items-center justify-center text-slate-400"
                    >
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                    >
                        <h2 className="text-2xl font-bold mb-4 text-slate-900 dark:text-slate-50">Nuestra Historia</h2>
